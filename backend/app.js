...
app.use("/", require("./routes/dvmRoute.js"));

app.use("/api/search/:text", async (req, res) => {
  const { text } = req.params;
  console.log(text);
  const endpoint = `https://api.locationiq.com/v1/autocomplete?key=pk.14360aabcdc3ab0ce852ee2c18d9df59&q=${text}&limit=15&dedupe=1`;
